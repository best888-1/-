...
public class ApartmentInfoServiceImpl extends ServiceImpl<ApartmentInfoMapper, ApartmentInfo>
    ...
    public void saveOrUpdateApartment(ApartmentSubmitVo apartmentSubmitVo) {
        ...
        if(isUpdate) {
            ...
            //删除配套列表
            LambdaQueryWrapper<ApartmentFacility> facilityQueryWrapperQueryWrapper = new LambdaQueryWrapper<>();
            facilityQueryWrapperQueryWrapper .eq(ApartmentFacility::getApartmentId,apartmentSubmitVo.getId());
            apartmentFacilityService.remove(facilityQueryWrapperQueryWrapper);
